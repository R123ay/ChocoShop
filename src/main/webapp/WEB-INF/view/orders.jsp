                ...
                <div class="container admin-container">
                    ...
                    <section class="container content-section">
                        <button type="button" class="btn btn-info ml-2"
                            onclick="downloadTableAsCSV('orderTable')">下載CSV</button>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="editOrderDetailsBtn"
                                    onclick="enableEditing()">編輯</button>
                                <button type="button" class="btn btn-success" id="saveOrderDetailsBtn"
                                    style="display: none;" onclick="saveOrderDetails()">儲存</button>
                            </div>
                        </div>
                    </div>
                </div>
