                                    ...
                                    <div class="shop-item">
                                        ...
                                        <div class="shop-item-details">
                                            ...
                                            <form action="<c:url value='/cart/add' />" method="post">
                                                ...
                                                <input class="shop-item-quantity" type="number" name="quantity"
                                                    value="1" min="1">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="confirmPurchaseForm" action="<c:url value='/cart/confirm' />"
                                            method="post">
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <input type="text" id="phone" name="phone"
                                                    onblur="validatePhoneNumber()" required>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary"
                                            onclick="confirmPurchase()">確認購買</button>
                                    </div>
                                </div>
                            </div>
                        </div>
