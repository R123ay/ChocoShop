            ...
            <body>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-custom"
                                            onclick="showEditModal(${product.id}, '${product.name}', '${product.category}', ${product.price}, '${product.imageUrl}')">編輯</button>
                ...
                <div class="modal fade" id="editProductModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="editProductForm" action="${pageContext.request.contextPath}/products/update"
                ...
                <script>
                    ...
                    function downloadTableAsCSV(tableId) {
                        ...
                        // Indexes of the columns to exclude (assuming "商品照片" and "操作" are the 5th and 8th columns)
                        ...
                        var csvContent = rows.map(function(row) {
                            ...
                            return cols.filter(function(col, index) {
                                ...
                                return col.innerText.replace(/"/g, '""'); // Escape double quotes
                            }).join('","');
                        }).join('"\n"');
                        csvContent = '\uFEFF"' + csvContent + '"'; // Add BOM for UTF-8 encoding
