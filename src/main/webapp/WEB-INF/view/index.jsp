            ...
            <body data-bs-spy="scroll" data-bs-target="#navbarMenu" data-bs-offset="200">
                ...
                <section id="sec1" class="pt-5">
                    ...
                    <div id="topSlider" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                ...
                                <picture>
                                    ...
                                    <source media="(min-width: 576px)"
                                        srcset="${pageContext.request.contextPath}/static/img/banner3.png">
                                    <img src="${pageContext.request.contextPath}/static/img/banner3.png"
                                        alt="Third slide">
                                </picture>
                            </div>
                        </div>

                        <button class="carousel-control-prev" type="button" data-bs-target="#topSlider"
                            data-bs-slide="prev">
                            <!-- 這個按鈕用來顯示上一張圖片 -->
                        ...
                        <button class="carousel-control-next" type="button" data-bs-target="#topSlider"
                            data-bs-slide="next">
                            <!-- 這個按鈕用來顯示下一張圖片 -->
                ...
                <section id="sec2">
                    ...
                    <nav>
                        ...
                        <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link active" id="p1-tab" data-bs-toggle="tab" data-bs-target="#p1"
                                type="button" role="tab" aria-controls="p1" aria-selected="true">精品系列</button>
                            <!-- 第一個標籤按鈕，設置為當前活躍的標籤 -->
