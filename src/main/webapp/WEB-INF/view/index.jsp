    ...
    <header class="bg-dark.text-white.text-center.py-3">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center justify-content-center" href="#">
                <img src="${pageContext.request.contextPath}/img/logo1.png" alt="品牌圖示">
            </a>
        </div>
    </header>
        ...
        <div id="topSlider" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <!-- 這是一張圖片，現在正在顯示 -->
                    <picture>
                        <source media="(min-width: 768px)" srcset="${pageContext.request.contextPath}/img/banner1.jpg">
                        <!-- 當螢幕寬度大於768像素時顯示這張圖片 -->
                        <source media="(min-width: 576px)" srcset="${pageContext.request.contextPath}/img/banner1.jpg">
                        <!-- 當螢幕寬度大於576像素時顯示這張圖片 -->
                        <img src="${pageContext.request.contextPath}/img/banner1.jpg" alt="First slide">
                        <!-- 這是顯示圖片的標籤 -->
                    </picture>
                </div>
                ...
                <div class="carousel-item">
                    <!-- 這是另一張圖片，現在還沒顯示 -->
                    <picture>
                        <source media="(min-width: 768px)" srcset="${pageContext.request.contextPath}/img/banner2.jpg">
                        <source media="(min-width: 576px)" srcset="${pageContext.request.contextPath}/img/banner2.jpg">
                        <img src="${pageContext.request.contextPath}/img/banner2.jpg" alt="Second slide">
                    </picture>
                </div>
                ...
                <div class="carousel-item">
                    <!-- 這是第三張圖片 -->
                    <picture>
                        <source media="(min-width: 768px)" srcset="${pageContext.request.contextPath}/img/banner3.png">
                        <source media="(min-width: 576px)" srcset="${pageContext.request.contextPath}/img/banner3.png">
                        <img src="${pageContext.request.contextPath}/img/banner3.png" alt="Third slide">
                    </picture>
                </div>
            </div>
    ...
    <section id="sec2">
        ...
        <nav>
            ...
            <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                ...
                <button class="nav-link active" id="p1-tab" data-bs-toggle="tab" data-bs-target="#p1" type="button"
                    role="tab" aria-controls="p1" aria-selected="true">經典精品</button>
                <!-- 第一個標籤按鈕，設置為當前活躍的標籤 -->
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="p1" role="tabpanel" aria-labelledby="p1-tab">
                <!--這是修改過的 `index.jsp` 檔案，以符合Spring Boot的語法，並確保您的原有設計不變：
...
<body data-bs-spy="scroll" data-bs-target="#navbarMenu" data-bs-offset="200">
    ...
    <section id="sec2">
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="p1" role="tabpanel" aria-labelledby="p1-tab">
                            <div class="container-xl">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-3 p-4" data-no="1">
                        <img src="${pageContext.request.contextPath}/img/s1-1.png" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                        <p class="text-center">最純粹的經典口味</p>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3 p-4" data-no="2">
                        <img src="${pageContext.request.contextPath}/img/s1-2.png" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                        <p class="text-center">不容錯過的當季限定商品</p>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3 p-4" data-no="3">
                        <img src="${pageContext.request.contextPath}/img/s1-3.png" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                        <p class="text-center">用專屬的巧克力紀錄美好的時光</p>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3 p-4" data-no="4">
                        <img src="${pageContext.request.contextPath}/img/s1-4.png" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                        <p class="text-center">測出為您最適合的巧克力</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-3 p-4">
                    <img src="${pageContext.request.contextPath}/img/sec3p2_1.jpg" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                    <p class="text-center">天然蘆薈洗顏乳</p>
                </div>
                <div class="col-12 col-sm-6 col-md-3 p-4">
                    <img src="${pageContext.request.contextPath}/img/sec3p2_2.jpg" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                    <p class="text-center">天然蘆薈化妝水</p>
                </div>
                <div class="col-12 col-sm-6 col-md-3 p-4">
                    <img src="${pageContext.request.contextPath}/img/sec3p2_3.jpg" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                    <p class="text-center">天然蘆薈精華乳</p>
                </div>
                <div class="col-12 col-sm-6 col-md-3 p-4">
                    <img src="${pageContext.request.contextPath}/img/sec3p2_4.jpg" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                    <p class="text-center">天然蘆薈精華液</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="tab-pane fade" id="p3" role="tabpanel" aria-labelledby="p3-tab">
        <div class="container-xl">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-3 p-4">
                    <img src="${pageContext.request.contextPath}/img/sec3p3_1.jpg" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                    <p class="text-center">天然蘆薈洗顏乳</p>
                </div>
                <div class="col-12 col-sm-6 col-md-3 p-4">
                    <img src="${pageContext.request.contextPath}/img/sec3p3_2.jpg" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                    <p class="text-center">天然蘆薈化妝水</p>
                </div>
                <div class="col-12 col-sm-6 col-md-3 p-4">
                    <img src="${pageContext.request.contextPath}/img/sec3p3_3.jpg" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                    <p class="text-center">天然蘆薈精華乳</p>
                </div>
                <div class="col-12 col-sm-6 col-md-3 p-4">
                    <img src="${pageContext.request.contextPath}/img/sec3p3_4.jpg" class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal" data-bs-target="#prodModal" alt="">
                    <p class="text-center">天然蘆薈精華液</p>
                </div>
            </div>
        </div>
...
Launch demo modal
    ...
    <div class="modal fade" id="prodModal" tabindex="-1" aria-labelledby="showProdLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-xl">
            ...
            <button type="button" class="btn-close float-end p-4 p-lg-3" data-bs-dismiss="modal" aria-label="Close"></button>
            <!-- 模態框內的關閉按鈕 -->
        </div>
    </div>
</div>
...
<script>
    ...
    $('#sec3 .col-12').on('click', function () {
        ...
        // 設置模態框商品名稱
        $('#prodModal .prod-img').attr('src', '${pageContext.request.contextPath}/img/care_prod_b/' + prod_img_array[no]);
        // 設置模態框商品圖片
