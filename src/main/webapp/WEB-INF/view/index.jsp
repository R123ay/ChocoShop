                ...
                <div class="container-xl">
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-3 p-4" data-no="1">
                            <img src="${pageContext.request.contextPath}/static/img/s1-1.png"
                        ...
                        <div class="col-12 col-sm-6 col-md-3 p-4" data-no="2">
                            <img src="${pageContext.request.contextPath}/static/img/s1-2.png"
                                 class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                 data-bs-target="#prodModal" alt="">
                            <p class="text-center">不容錯過的當季限定商品</p>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3 p-4" data-no="3">
                            <img src="${pageContext.request.contextPath}/static/img/s1-3.png"
                                 class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                 data-bs-target="#prodModal" alt="">
                            <p class="text-center">用專屬的巧克力紀錄美好的時光</p>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3 p-4" data-no="4">
                            <img src="${pageContext.request.contextPath}/static/img/s1-4.png"
                                 class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                 data-bs-target="#prodModal" alt="">
