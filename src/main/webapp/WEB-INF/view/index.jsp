            ...
            <div id="topSlider" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <picture>
                            <source media="(min-width: 768px)"
                                srcset="${pageContext.request.contextPath}/img/banner1.jpg">
                            <!-- 當螢幕寬度大於768像素時顯示這張圖片 -->
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(min-width: 768px)"
                                srcset="${pageContext.request.contextPath}/img/banner2.jpg">
                            <source media="(min-width: 576px)"
                                srcset="${pageContext.request.contextPath}/img/banner2.jpg">
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(min-width: 768px)"
                                srcset="${pageContext.request.contextPath}/img/banner3.png">
                            <source media="(min-width: 576px)"
                                srcset="${pageContext.request.contextPath}/img/banner3.png">
        ...
        <section id="sec2">
            ...
            <nav>
                ...
                <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="p3-tab" data-bs-toggle="tab" data-bs-target="#p3" type="button"
                        role="tab" aria-controls="p3" aria-selected="false">絲絨生巧</button>

                    <button class="nav-link" id="p4-tab" data-bs-toggle="tab" data-bs-target="#p4" type="button"
                        role="tab" aria-controls="p4" aria-selected="false">趣選巧克</button>
                </div>
            </nav>
                    ...
                    <div class="container-xl">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-3 p-4" data-no="1">
                                <img src="${pageContext.request.contextPath}/img/s1-1.png"
                ...
                <div class="container-xl">
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-3 p-4">
                            <img src="${pageContext.request.contextPath}/img/sec3p2_1.jpg"
                                class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                data-bs-target="#prodModal" alt="">
                            <p class="text-center">天然蘆薈洗顏乳</p>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3 p-4">
                            <img src="${pageContext.request.contextPath}/img/sec3p2_2.jpg"
                                class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                data-bs-target="#prodModal" alt="">
                            <p class="text-center">天然蘆薈化妝水</p>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3 p-4">
                            <img src="${pageContext.request.contextPath}/img/sec3p2_3.jpg"
                                class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                data-bs-target="#prodModal" alt="">
                            <p class="text-center">天然蘆薈精華乳</p>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3 p-4">
                            <img src="${pageContext.request.contextPath}/img/sec3p2_4.jpg"
                                class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                data-bs-target="#prodModal" alt="">
            ...
            <div class="tab-pane fade" id="p3" role="tabpanel" aria-labelledby="p3-tab">
                <div class="container-xl">
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-3 p-4">
                            <img src="${pageContext.request.contextPath}/img/sec3p3_1.jpg"
                                class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                data-bs-target="#prodModal" alt="">
                            <p class="text-center">天然蘆薈洗顏乳</p>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3 p-4">
                            <img src="${pageContext.request.contextPath}/img/sec3p3_2.jpg"
                                class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                data-bs-target="#prodModal" alt="">
                            <p class="text-center">天然蘆薈化妝水</p>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3 p-4">
                            <img src="${pageContext.request.contextPath}/img/sec3p3_3.jpg"
                                class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                data-bs-target="#prodModal" alt="">
                            <p class="text-center">天然蘆薈精華乳</p>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3 p-4">
                            <img src="${pageContext.request.contextPath}/img/sec3p3_4.jpg"
                                class="d-block mw-100 mx-auto rounded mb-2" data-bs-toggle="modal"
                                data-bs-target="#prodModal" alt="">
                            <p class="text-center">天然蘆薈精華液</p>
                        </div>
